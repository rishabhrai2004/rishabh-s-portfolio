...
export default function About() {
  return (
    <section id="about" className="py-28 px-6 lg:px-12 bg-transparent text-white relative flex flex-col items-center border-t border-white/5">
      <div className="max-w-4xl mx-auto z-10 w-full text-center">
        ...
        >
          <div className="flex items-center justify-center gap-4 mb-12">
            <span className="text-accent tracking-[0.2em] text-sm font-bold uppercase">01 // The Approach</span>
          </div>

          <h2 className="text-4xl md:text-6xl leading-tight font-display tracking-tight mb-16">
          ...
          <div className="font-body text-lg text-white/50 tracking-wide leading-relaxed">
            <p className="mb-6">
